...
import static by.academypvt.api.dto.order.State.*;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (action.equals("change")) {
                ...
                if (state.equals("INCOMPLETED")) {
                    thisState = State.INCOMPLETED;
                } else if (state.equals("WAITING_FOR_DEPART")) {
                    thisState = State.WAITING_FOR_DEPART;
                } else if (state.equals("ON_THE_WAY")) {
                    thisState = State.ON_THE_WAY;
                } else if (state.equals("DONE")) {
                    thisState = State.DONE;
                }
                orderService.toChangeOrderForAdmin(id,thisState);
